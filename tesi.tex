...
\input{capitoli/capitolo-2}             % Progetto
\input{capitoli/capitolo-3}             % Tecnologie
\input{capitoli/capitolo-4}             % Analisi
\input{capitoli/capitolo-5}             % Progettazione e codifica
\input{capitoli/capitolo-6}				% Funzionalità ottenute
\input{capitoli/capitolo-7}             % Conclusioni  
\appendix
\input{capitoli/Appendice-A}			% appendice requisiti
\input{capitoli/Appendice-B}			% appendice casi d'uso
\input{capitoli/Appendice-C}			% appendice diagrammi attività
\input{capitoli/Appendice-D}			% appendice diagrammi delle classi
 \facciatabianca                   
%**************************************************************
% Materiale finale
%**************************************************************
