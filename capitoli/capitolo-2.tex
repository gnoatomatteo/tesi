...
\\
Sono state valutate varie librerie commerciali per la generazione del pdf a partire da un template, ma nessuna offriva realmente ciò che interessava all'azienda, pertanto si è deciso di puntare su un template \textit{XSLT\ped{G}} che a partire da un \textit{XML\ped{G}} con associato un foglio di stile, permette la generazione di una pagina \textit{HTML\ped{G}} che a sua volta sarà convertita in \textit{pdf\ped{G}} grazie alle funzionalità offerte da pacchetto \textit{iTextSharp\ped{G}}.
